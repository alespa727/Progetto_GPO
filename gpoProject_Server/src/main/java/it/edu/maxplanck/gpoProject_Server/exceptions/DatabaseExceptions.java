...
public enum DatabaseExceptions {
    ...
    DB_USERNAME_IS_ALREADY_IN_USE("Username già in uso", HttpStatus.CONFLICT),

    // Amicizie
    DB_FRIENDSHIP_ALREADY_CREATED("Amicizia già creata", HttpStatus.CONFLICT),
    DB_FRIENDSHIP_NOT_CREATED("Creazione non riuscita", HttpStatus.BAD_REQUEST),

    // Chat
    DB_CHAT_NOT_FOUND("Chat non trovata", HttpStatus.NOT_FOUND),
    DB_CHAT_ALREADY_CREATED("Chat già creata", HttpStatus.CONFLICT),
    DB_USER_IS_NOT_PART_OF_CHAT("L'utente non fa parte della chat", HttpStatus.FORBIDDEN),

    // Chiamate
    DB_CALL_STILL_OPEN("Una altra chiamata ancora attiva", HttpStatus.BAD_REQUEST),
    ...
    DB_USER_IS_NOT_PART_OF_COMMUNITY("L'utente non fa parte della community", HttpStatus.FORBIDDEN),
    ...
    // Registrazioni
    DB_REGISTRATION_ALREADY_CREATED("Iscrizione già avvenuta", HttpStatus.CONFLICT),
    DB_REGISTRATION_NOT_FOUND("Iscrizione non trovata", HttpStatus.NOT_FOUND),
    DB_REGISTRATION_NOT_DONE("Iscrizione non terminata", HttpStatus.FORBIDDEN),
    ...
    // MESSAGGI
    DB_UNAUTHORIZED("Non hai i permessi", HttpStatus.FORBIDDEN),
    DB_FORBIDDEN("Non puoi", HttpStatus.FORBIDDEN);

    private final String message;
    private final HttpStatus responseStatus;

    DatabaseExceptions(String message, HttpStatus responseStatus) {
