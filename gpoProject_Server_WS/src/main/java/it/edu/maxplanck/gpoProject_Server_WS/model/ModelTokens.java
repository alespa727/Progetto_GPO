...
public class ModelTokens {
	...
	public static final String accessTokenSubjectPath = "${jwt.Subject.Token.Access:#{Access_Token}}";
	...
	public static final String refreshTokenSubjectPath = "${jwt.Subject.Token.Refresh:#{Refresh_Token}}";
